...
def check_keydown_events(event, ai_settings, screen, ship, bullets,
	stats, aliens, play_button, sb):
		...
		if event.key == pygame.K_RIGHT:
			...
			check_play_p(ai_settings, screen, stats, play_button, 
...
def check_events(ai_settings, screen, ship, bullets, aliens, play_button, stats, sb):
	...
	for event in pygame.event.get():
		...
		if event.type == pygame.QUIT:
			...
			check_play_button(ai_settings, screen, stats, play_button, 
				ship, aliens, mouse_x, mouse_y, bullets, sb)

def check_play_p(ai_settings, screen, stats, play_button, 
	ship, aliens, bullets, sb):
...
def check_bullet_alien_collisions(ai_settings, screen, ship, aliens, bullets, sb, stats):
	...
	#логические аргументы удалять ли пули, пришельцев?
	#Возвращает словарь
	collisions = pygame.sprite.groupcollide(bullets, aliens, True, True)
	if collisions:
		for aliens in collisions.values():
			#Домножаем на  len(aliens) на случай широкой пули
...
def create_fleet(ai_settings, screen, ship, aliens):
	...
	alien = Alien(ai_settings, screen) #создаём чтобы знать его характеристики
	alien_width = alien.rect.width
